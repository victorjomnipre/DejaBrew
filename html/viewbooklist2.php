        ...
        <?php
            foreach($books as $title=>$MybookList) {
                echo "<tr>";
                    ...
                    echo "<td>". $MybookList->category ."</td>";    
                    echo "<td>". $MybookList->ingredients ."</td>";                                    
                    echo "<td>Edit | <a href='index.php?command=deleteRec&&coffee_id=".$MybookList->coffee_id."' onclick='return confirm(\"Are you sure you want to do Delete this record?\")'>Delete</a></td>";
                echo "</tr>";
            }
        ?>
    </tbody>
